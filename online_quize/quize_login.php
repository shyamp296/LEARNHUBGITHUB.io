		...
		<div class="row" >
			...
			<div class="card" >
				<div class=" card-header card-primary p-1">
					<h2 class="text-success text-center">WELCOME TO LEARN HUB</h2>

				</div>
				<div class="card-body p-1">
					<h4 class="text-secondary text-center">solve the quiz and get good performance in your carrier </h4>
				</div>
			</div>
		</div>
		</div>
