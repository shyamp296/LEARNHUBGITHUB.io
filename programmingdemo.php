...
.div1                           /* for title image*/
{
   ...
   position: relative;
    height: 500px;
    width: 1263px;
    background:url(uploadimg/2.jpg);
}
          ...
          <div class="row row-30">
            <div class="col-md-4 col-xl-5">
              <div class="pr-xl-4"><a class="brand" href="index.html"><img class="brand-logo-light" src="images/agency/logo-inverse-140x37.png" alt="" width="140" height="37" srcset="images/agency/logo-retina-inverse-280x74.png 2x"></a>
                <p>DSD Devloper is an excellent learning hub, dedicated to the programmer who want to explore.</p>
                <!-- Rights-->
                <p class="rights"><span>©  </span><span class="copyright-year">2018</span><span> </span><span>DSDDeveloper</span><span>. </span><span>All Rights Reserved.</span></p>
              </div>
            </div>
            <div class="col-md-4">
              <h5>Contacts</h5>
              ...
              <dl class="contact-list">
                <dt>email:</dt>
                <dd><a href="mailto:#">DSDdeveloper0@gmail.com</a></dd>
              </dl>
              <dl class="contact-list">
                <dt>phones:</dt>
