	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">LEARN HUB</h1>
			</div>
					...
					<div class="slider-content">
						...
						<div class="text">      <!-- jquery typed effect -->
							...
							<div class="social-networks">
								<a href="https://www.facebook.com/dsdfoundation03" class="fa fa-facebook"></a>
								<a href="https://twitter.com/DSDdevelopers" class="fa fa-twitter"></a>
								<a href="https://www.instagram.com/dsd_developers/" class="fa fa-instagram"></a>
								
								<a href="https://www.linkedin.com/in/dsd-developers-72366b222/" class="fa fa-linkedin"></a>
						...
						<div id="team-memebers" class="owl-carousel owl-theme">
							<div class="team-member text-center">
								...
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Shyam Dadhaniya</h4>
							...
							<div class="team-member text-center">
								...
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Dhawanil Dattani</h4>
									<h4 class="team-member-designation"> Design Manager</h4>
							...
							<div class="team-member text-center">
								...
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Dhruv Joshi</h4>
									<h4 class="team-member-designation"> HR </h4>
